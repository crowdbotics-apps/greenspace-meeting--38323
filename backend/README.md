...
## Project Structure
    ...
    ├── greenspace_meeting__38323  # Django project configurations
...
1. Clone this repo and `cd greenspace_meeting__38323`
...
2. Clone this repo and `cd greenspace_meeting__38323`
